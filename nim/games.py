...
class TicTacToe(Game):
    """Play TicTacToe on an h x v board, with Max (first player) playing 'Player 1'.
    A state has the player to move, a cached utility, a list of moves in
    the form of a list of (x, y) positions, and a board, in the form of
    a dict of {(x, y): Player} entries, where Player is 'Player 1' or 'Player 2'."""
    ...
    def __init__(self, h=3, v=3, k=3):
        ...
        self.initial = GameState(to_move='Player 1', utility=0, board={}, moves=moves)
